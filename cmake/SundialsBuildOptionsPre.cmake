...
if(IS_DIRECTORY "${SUNDIALS_SOURCE_DIR}/src/arkode")
  sundials_option(SUNDIALS_ENABLE_ARKODE BOOL "Enable the ARKODE library" ON DEPRECATED_NAME BUILD_ARKODE)
...
if(IS_DIRECTORY "${SUNDIALS_SOURCE_DIR}/src/cvode")
  sundials_option(SUNDIALS_ENABLE_CVODE BOOL "Enable the CVODE library" ON DEPRECATED_NAME BUILD_CVODE)
...
if(IS_DIRECTORY "${SUNDIALS_SOURCE_DIR}/src/cvodes")
  sundials_option(SUNDIALS_ENABLE_CVODES BOOL "Build the CVODES library" ON DEPRECATED_NAME BUILD_CVODES)
...
if(IS_DIRECTORY "${SUNDIALS_SOURCE_DIR}/src/ida")
  sundials_option(SUNDIALS_ENABLE_IDA BOOL "Build the IDA library" ON DEPRECATED_NAME BUILD_IDA)
...
if(IS_DIRECTORY "${SUNDIALS_SOURCE_DIR}/src/idas")
  sundials_option(SUNDIALS_ENABLE_IDAS BOOL "Build the IDAS library" ON DEPRECATED_NAME BUILD_IDAS)
...
if(IS_DIRECTORY "${SUNDIALS_SOURCE_DIR}/src/kinsol")
  sundials_option(SUNDIALS_ENABLE_KINSOL BOOL "Build the KINSOL library" ON DEPRECATED_NAME BUILD_KINSOL)
