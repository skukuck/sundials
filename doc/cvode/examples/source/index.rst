...
.. only:: html
   ...
   The CVODE examples documentation is intended to serve as a companion document
   to the CVODE User Documentation. These example programs demonstrate a large
