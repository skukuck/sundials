...
sources. For example, if you downloaded ``sundials-7.6.0.tar.gz``, running the
command

.. code-block:: bash

   tar -zxf sundials-7.6.0.tar.gz

will extract the source files under the ``sundials-7.6.0`` directory.
