                 ...
                 sunindextype dsizex, sunindextype dsizey, sunrealtype uarray[])
{
  ...
  if (jysub != NPEY - 1)
  {
    ...
    MPI_Send(&uarray[offsetu], (int)dsizex, MPI_SUNREALTYPE, thispe + NPEX, 0,
             comm);
  }
                     ...
                     sunrealtype uext[], sunrealtype buffer[])
{
  ...
  if (jysub != 0)
  {
    MPI_Irecv(&uext[1], (int)dsizex, MPI_SUNREALTYPE, thispe - NPEX, 0, comm,
              &request[0]);
  }
  ...
  if (jysub != NPEY - 1)
  {
    ...
    MPI_Irecv(&uext[offsetue], (int)dsizex, MPI_SUNREALTYPE, thispe + NPEX, 0,
              comm, &request[1]);
  }
  ...
  if (ixsub != 0)
  {
    MPI_Irecv(&bufleft[0], (int)dsizey, MPI_SUNREALTYPE, thispe - 1, 0, comm,
              &request[2]);
  }
  ...
  if (ixsub != NPEX - 1)
  {
    MPI_Irecv(&bufright[0], (int)dsizey, MPI_SUNREALTYPE, thispe + 1, 0, comm,
              &request[3]);
  }
