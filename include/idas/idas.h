...
SUNDIALS_EXPORT int IDAGetCurrentYSens(void* ida_mem, N_Vector** yS_1d_out); // nb::rv_policy::reference
SUNDIALS_EXPORT int IDAGetCurrentYp(void* ida_mem, N_Vector* ypcur); // nb::rv_policy::reference
SUNDIALS_EXPORT int IDAGetCurrentYpSens(void* ida_mem, N_Vector** ypS_1d_out); // nb::rv_policy::reference
