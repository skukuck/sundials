...
typedef int (*KINDampingFn)(long int iter, N_Vector u_val, N_Vector g_val,
                            sunrealtype* qt_fn_1d, long int depth, void* user_data,
                            sunrealtype* damping_factor_ptr);

typedef int (*KINDepthFn)(long int iter, N_Vector u_val, N_Vector g_val,
                          N_Vector f_val, N_Vector* df_1d, sunrealtype* R_mat_1d,
                          long int depth, void* user_data, long int* new_depth_ptr,
