...
SWIGEXPORT N_Vector _wrap_FN_VNew_ManyVector(int32_t const *farg1, void *farg2, void *farg3) {
  N_Vector fresult ;
  sunindextype arg1 ;
...
SWIGEXPORT N_Vector _wrap_FN_VGetSubvector_ManyVector(N_Vector farg1, int32_t const *farg2) {
  N_Vector fresult ;
...
SWIGEXPORT int _wrap_FN_VSetSubvectorArrayPointer_ManyVector(double *farg1, N_Vector farg2, int32_t const *farg3) {
  int fresult ;
...
SWIGEXPORT int32_t _wrap_FN_VGetNumSubvectors_ManyVector(N_Vector farg1) {
  int32_t fresult ;
  N_Vector arg1 = (N_Vector) 0 ;
  sunindextype result;
...
SWIGEXPORT int32_t _wrap_FN_VGetLength_ManyVector(N_Vector farg1) {
  int32_t fresult ;
  N_Vector arg1 = (N_Vector) 0 ;
  sunindextype result;
...
SWIGEXPORT int32_t _wrap_FN_VGetSubvectorLocalLength_ManyVector(N_Vector farg1, int32_t const *farg2) {
  int32_t fresult ;
  N_Vector arg1 = (N_Vector) 0 ;
  sunindextype arg2 ;
  sunindextype result;
...
SWIGEXPORT int _wrap_FN_VBufSize_ManyVector(N_Vector farg1, int32_t *farg2) {
  int fresult ;
  N_Vector arg1 = (N_Vector) 0 ;
  sunindextype *arg2 = (sunindextype *) 0 ;
  SUNErrCode result;
