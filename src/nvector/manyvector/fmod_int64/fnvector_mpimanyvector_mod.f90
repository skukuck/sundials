...
function swigc_FN_VCopy_MPIManyVector(farg1, farg2) &
bind(C, name="_wrap_FN_VCopy_MPIManyVector") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_PTR), value :: farg2
...
function FN_VCopy_MPIManyVector(x, z) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(N_Vector), target, intent(inout) :: x
...
farg1 = c_loc(x)
farg2 = c_loc(z)
fresult = swigc_FN_VCopy_MPIManyVector(farg1, farg2)
swig_result = fresult
end function
