...
SWIGEXPORT int32_t _wrap_FN_VGetLength_Serial(N_Vector farg1) {
  int32_t fresult ;
...
SWIGEXPORT int _wrap_FN_VCopy_Serial(N_Vector farg1, N_Vector farg2) {
  int fresult ;
  N_Vector arg1 = (N_Vector) 0 ;
  N_Vector arg2 = (N_Vector) 0 ;
  SUNErrCode result;
  ...
  arg1 = (N_Vector)(farg1);
  arg2 = (N_Vector)(farg2);
  result = (SUNErrCode)N_VCopy_Serial(arg1,arg2);
...
SWIGEXPORT int _wrap_FN_VBufSize_Serial(N_Vector farg1, int32_t *farg2) {
  int fresult ;
  N_Vector arg1 = (N_Vector) 0 ;
  sunindextype *arg2 = (sunindextype *) 0 ;
  SUNErrCode result;
