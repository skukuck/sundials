...
int main(int argc, char* argv[])
{
  ...
  datafile
    << "# t, y1, y2, est err1, est err2, lambda1, lambda2, stiffness ratio\n";
  ...
  datafile << setw(26) << t0 << setw(26) << ydata[0] << setw(26) << ydata[1]
           << setw(26) << 0.0 << setw(26) << 0.0 << setw(26) << lambda1.real()
           << showpos << lambda1.imag() << noshowpos << "j" << setw(26)
           << lambda2.real() << showpos << lambda2.imag() << noshowpos << "j"
