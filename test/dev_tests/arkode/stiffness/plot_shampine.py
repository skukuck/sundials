...
ax1.plot(data["t"], data["y3"], label="y3")
ax1.legend(loc="best")
ax1.set_xlabel("time")
if args.title:
    ax1.set_title(f"{args.title} Solution (Stiffness Ratio = {stiffness_ratio:.2f})")
else:
    ax1.set_title(f"Solution (Stiffness Ratio = {stiffness_ratio:.2f})")
